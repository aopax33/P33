...
class RateProductScreen extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<RateProductScreen> createState() =>
      _RateProductScreenState();
}
...
class _RateProductScreenState extends ConsumerState<RateProductScreen> {
  ...
  Future<void> _submit() async {
    ...
    await ref.read(submitRatingNotifierProvider.notifier).submit(
          productId: widget.productId,
          score: _score.round(),
          liked: _liked,
        );
    if (mounted) {
      final state = ref.read(submitRatingNotifierProvider);
      if (state.success) {
        ScaffoldMessenger.of(context).showSnackBar(
          const SnackBar(
  ...
  Widget build(BuildContext context) {
    final productAsync =
        ref.watch(productStreamProvider(widget.productId));
    final existingRating =
        ref.watch(userProductRatingProvider(widget.productId));
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Text('${product.company} · ${product.store}',
                ...
                if (existingRating.valueOrNull != null)
                  Padding(
                    ...
                    child: TextButton(
                      ...
                      child: const Text('Remove My Rating',
